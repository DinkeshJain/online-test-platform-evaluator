...
import { ClipboardCheck, Mail, Lock, ArrowRight } from 'lucide-react';
import '../App.css';
        ...
        <Card className="shadow-lg border border-gray-300 overflow-hidden">
          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <Button type="submit" disabled={loading} className="w-full h-10 text-sm bg-green-600 hover:bg-green-700 mt-4">
                {loading ? (
                  <>
